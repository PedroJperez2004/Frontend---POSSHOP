...
//                                 {/* AJUSTE DE COLUMNAS PARA DAR ESPACIO */}
...
//                                                 <div className="w-10 h-10 rounded-lg bg-[#12121B] border border-[#3A3A55] overflow-hidden flex items-center justify-center shrink-0">
//                                                     {mainImage ? (
//                                                         <img
...
import { usePagination } from '../../../shared/hooks/usePagination';
import PaginationControls from '../../../components/PaginationControls'; 
import ImageModal from '../../../components/ImageModal'; // Asegúrate de que el nombre del archivo coincida
...
export default function ProductList({ 
    ...
    // Estado para controlar qué imagen se ve en grande
    ...
    return (
        <div className="w-full h-full min-h-[600px] flex flex-col font-sans">
            ...
            {/* Visualizador de Imagen Grande (Modal) */}
            {selectedImage && (
                <ImageModal 
                            ...
                            {paginatedItems.map((product, index) => {
                                ...
                                return (
                                    <tr key={product.id} className="hover:bg-[#2C2C3E]/40 transition-colors group">
                                        ...
                                        <td className="px-4 md:px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                {/* Miniatura con Click para abrir modal */}
                                                <div 
