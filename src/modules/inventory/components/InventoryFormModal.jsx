                ...
                <form onSubmit={handleSubmit} className="p-6 flex-1 overflow-y-auto space-y-6 custom-scrollbar">
                    ...
                    <div className="relative">
                        ...
                        {isSearching && !formData.product_id && (
                            <div className="absolute z-20 w-full mt-1 bg-[#2C2C3E] border border-[#3A3A55] rounded-xl shadow-2xl overflow-hidden p-1 animate-in fade-in slide-in-from-top-2 duration-200">
                                <div className="px-3 py-2 border-b border-[#3A3A55] mb-1">
                                ...
                                {filteredProducts.length > 0 ? (
                                    filteredProducts.map(p => (
                                        <button
                                            ...
                                            className="w-full px-4 py-3 hover:bg-[#FFC857] hover:text-[#12121B] text-left text-sm text-[#F5F5F5] flex justify-between items-center rounded-lg transition-all group"
                                        >
                                            <div className="flex flex-col">
                                                <span className="font-bold">{p.name}</span>
                                                <span className="text-[10px] opacity-60 group-hover:text-[#12121B]">ID: {p.id}</span>
                                            </div>
                                            <div className="bg-[#12121B]/40 px-2 py-1 rounded text-[10px] font-black group-hover:bg-[#12121B]/20">
                                                STOCK: {p.stock || 0}
                                            </div>
                                        </button>
                                    ))
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className={`py-4 rounded-xl border-2 font-black text-[10px] uppercase transition-all flex flex-col items-center gap-1 ${
                                formData.type === 'in' 
