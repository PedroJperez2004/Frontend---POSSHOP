...
const CartItem = ({ item, onUpdate, onRemove }) => {
    return (
        <div className="bg-[#2C2C3E]/40 border border-[#3E3E52] p-3 rounded-xl flex items-center gap-3 group animate-in fade-in slide-in-from-right-4 duration-200">
            ...
            {/* Botón Eliminar: visible en móvil (opacity-100), sutil en desktop */}
            <button 
                onClick={() => onRemove(item.id)}
                className="p-2 text-[#A0A0B0]/40 lg:opacity-0 lg:group-hover:opacity-100 hover:text-[#E74C3C] transition-all"
            >
